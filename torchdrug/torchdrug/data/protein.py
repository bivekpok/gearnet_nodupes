...
class Protein(Molecule):
    ...
    #
    # residue2id ={
    #                 "GLY": 0, "ALA": 0, "SER": 0, "PRO": 0, "VAL": 0, "THR": 0, "CYS": 0, "ILE": 0, "LEU": 0,
    #                 "ASN": 0, "ASP": 0, "GLN": 0, "LYS": 0, "GLU": 0, "MET": 0, "HIS": 0, "PHE": 0,
    #                 "ARG": 0, "TYR": 0, "TRP": 0}
    # residue2id ={
    #     "GLY": 0, "ALA": 0, "SER": 0, "PRO": 0, "VAL": 0, "THR": 0, "CYS": 0, "ILE": 0, "LEU": 0,
    #     "ASN": 0, "ASP": 1, "GLN": 0, "LYS": 1, "GLU": 1, "MET": 0, "HIS": 1, "PHE": 0,
    #     "ARG": 1, "TYR": 0, "TRP": 0}
    ...
    def node_feature(self):
        if getattr(self, "view", "atom") == "atom":
            # print(f' self.atom_feature { self.atom_feature }')
            return self.atom_feature
        else:
            # print(f'self.residue_feature {self.residue_feature}')
    ...
    def from_pdb(cls, pdb_file, atom_feature="default", bond_feature="default", residue_feature="default",
        ...
        if mol is None:
            print('this is inside the mol None')
            print(pdb_file)
